...
class GameSettings(GameResource):
	...
	def ReadGmx(self, root):
		...
		for child in root:
			...
			elif child.tag==option+"closeesc":#clifix
	...
	def WriteESGameSettings(self):
		...
		#og.frontLoadBar,false);
		#og.backLoadBar,false);
		#og.showCustomLoadImage = 
		#og.loadingImage,false);
...
class GameFile(GameResource):
	...
	def populateSettings(self):
		...
		og=self.settings.WriteESGameSettings()
		og.gameId = self.gameId
		self.es.gameSettings=pointer(og)
